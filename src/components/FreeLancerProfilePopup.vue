...
================================================== -->
  <div
    id="freelancer-profile-dialog"
    class="simple-dialog zoom-anim-dialog mfp-hide dialog-with-tabs"
  >
    <div
            ...
            <div class="single-page-header-inner">
              <div class="left-side">
                ...
                <div class="header-details">
                  <h3>{{ profile.name }} <span>iOS Expert + Node Dev</span></h3>
                  <ul>
        ...
        <div class="col-xl-8 col-lg-8 content-right-offset">
          ...
          <div class="boxed-list margin-bottom-60">
            <div class="boxed-list-headline">
              <h3>
                <i class="icon-material-outline-thumb-up"></i> Work History and
                Feedback
              </h3>
            </div>
                  ...
                  <div class="item-content">
                    ...
                    <div class="item-details margin-top-10">
                      ...
                      <div class="detail-item">
                        <i class="icon-material-outline-date-range"></i> August
                        2019
                      </div>
                    </div>
                  ...
                  <div class="item-content">
                    ...
                    <div class="item-description">
                      <p>
                        ...
                        how quickly he got it done. He then offered to help with
                        another side part of the project that we didn't even
                        think about originally.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div class="sidebar-container">
            ...
            <div class="profile-overview">
              <div class="overview-item">
                <strong>$35</strong><span>Hourly Rate</span>
              </div>
              <div class="overview-item">
...
<script>
export default {
  name: "FreeLancerProfilePopup",
  computed: {
    profile() {
      return this.$store.getters.freelancer;
    },
  },
  //   watch: {
  //     profile: (val) => {
